...
const installCommands: ManagerCommand[] = [
  { id: 'npm', label: 'npm', cmd: 'npm install -g agent-cu' },
  { id: 'pnpm', label: 'pnpm', cmd: 'pnpm add -g agent-cu' },
  { id: 'yarn', label: 'yarn', cmd: 'yarn global add agent-cu' },
  { id: 'bun', label: 'bun', cmd: 'bun add -g agent-cu' },
];
